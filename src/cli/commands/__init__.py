...
from src.cli.commands.parse_change_name.parse_change_name import parse_change_name
...
from src.cli.commands.parser_extract.parser_extract import parser_extract
