EXPECTED_SONAR_JSON_COMPONENTS = [
        {
            ...
            'name': '__init__.py', 'qualifier': 'UTS', 'path': 'tests/__init__.py',
            'language': 'py', 'measures': [
        ...
        },
        {
            ...
            'name': 'cli.py', 'qualifier': 'FIL', 'path': 'measuresoftgram/cli.py',
            'language': 'py', 'measures': [
        ...
        },
        {
            ...
            'name': 'hello_world_test.py', 'qualifier': 'UTS', 'path': 'tests/hello_world_test.py',
            'language': 'py', 'measures': [
                {'metric': 'security_rating', 'value': '1.0', 'bestValue': True},
        ...
        },
        {
            ...
            'name': 'measuresoftgram', 'qualifier': 'DIR', 'path': 'measuresoftgram',
            'measures': [
                {'metric': 'duplicated_lines_density', 'value': '0.0', 'bestValue': True},
                {'metric': 'functions', 'value': '2'},
                {'metric': 'security_rating', 'value': '1.0', 'bestValue': True},
        ...
        },
        {
            ...
            'name': 'tests', 'qualifier': 'DIR', 'path': 'tests',
            'measures': [
                {'metric': 'test_execution_time', 'value': '2'},
                {'metric': 'test_failures', 'value': '0', 'bestValue': True},
                {'metric': 'test_errors', 'value': '0', 'bestValue': True},
